...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        todos.add(new Todo("1", "description1", R.mipmap.ic_launcher_round));
        todos.add(new Todo("2", "description2" , R.mipmap.ic_launcher_round));
        todos.add(new Todo("3", "description3" , R.mipmap.ic_launcher_round));
        todos.add(new Todo("4", "description4" , R.mipmap.ic_launcher_round));
        todos.add(new Todo("5", "description5" , R.mipmap.ic_launcher_round));
        todos.add(new Todo("1", "description1" , R.mipmap.ic_launcher_round));
        todos.add(new Todo("2", "description2" ,  R.mipmap.ic_launcher_round));
        todos.add(new Todo("3", "description3" , R.mipmap.ic_launcher_round));
        todos.add(new Todo("4", "description4" , R.mipmap.ic_launcher_round));
